...
| `HANDLE_NET_URL`                    | The URL of the handle server to use (e.g. https://hdl.handle.net)                                                                                                                                                                                                                                                                     |
| `HANDLE_NET_PREFIX`                 | The prefix to use when creating handles for data and blobs in CDCS                                                                                                                                                                                                                                                                    |
